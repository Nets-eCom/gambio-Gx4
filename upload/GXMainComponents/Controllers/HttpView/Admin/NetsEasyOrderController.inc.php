...
class NetsEasyOrderController extends AdminHttpViewController {
    ...
    public function actionCharge() {
        ...
        xtc_redirect(xtc_href_link("orders.php?oID=$orderid&action=edit&overview[do]=OrdersOverview", '', 'SSL'));
    }
     ...
     * @param $orderid gambio order id alphanumeric
    ...
    public function getResponse($oder_id) {
        $payment_id = $this->getPaymentId($oder_id);
    ...
    /*
     * Function to fetch charge id from databse table gxnets
     * @param $orderid
